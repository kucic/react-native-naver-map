...
const codef = latitudeDelta / longitudeDelta;
...
export const convertBBox = (lat, lon, zoom) => {
    return GeoViewport.bounds([lat,lon], zoom, [width,height]);
}
